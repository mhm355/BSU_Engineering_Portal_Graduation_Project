...
export default function PublishResultsDean() {
    ...
    const handleToggle = async (id, currentStatus) => {
        ...
        try {
            ...
            setError(err.response?.data?.error || 'فشل في تحديث حالة الإعلان');
        } finally {
            setUpdatingId(null);
        }
    };
                    ...
                    <CardContent sx={{ p: 3 }}>
                        ...
                        <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
                            ...
                            <Button 
                                ...
                                sx={{ fontFamily: 'Cairo', fontWeight: 'bold', borderRadius: 2, px: 4 }}
                            >
                                بحث
                            </Button>
                        </Box>
                            ...
                            <Table>
                                <TableHead sx={{ bgcolor: '#f8fafc' }}>
                                    <TableRow>
                                        ...
                                        <TableCell sx={{ fontFamily: 'Cairo', fontWeight: 'bold', py: 2.5, textAlign: 'center', color: '#475569' }}>شئون الطلاب</TableCell>
                                        <TableCell sx={{ fontFamily: 'Cairo', fontWeight: 'bold', py: 2.5, textAlign: 'center', color: '#475569' }}>موافقة العميد</TableCell>
                                    ...
                                    {statuses.map((status) => (
                                        <TableRow key={status.id} hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                            ...
                                            <TableCell sx={{ textAlign: 'center' }}>
                                                {status.student_affairs_approved ? 
                                            ...
                                            <TableCell sx={{ textAlign: 'center' }}>
                                                {updatingId === status.id ? (
                                                    ...
                                                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
                                                        <Switch 
                                                            checked={status.admin_approved} 
                                                            onChange={() => handleToggle(status.id, status.admin_approved)}
                                                            color="primary"
                                                            sx={{
