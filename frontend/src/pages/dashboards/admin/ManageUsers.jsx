...
export default function ManageUsers() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f5f7fa 0%, #e4e8ec 100%)', pb: 6 }}>
            <Box sx={{ background: 'linear-gradient(135deg, #FF6B35 0%, #F7931E 100%)', pt: 3, pb: 4, mb: 3, position: 'relative', overflow: 'hidden' }}>
                    ...
                    <Fade in={true} timeout={800}>
                        <Box>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                                <Avatar sx={{ width: 55, height: 55, bgcolor: 'rgba(255,255,255,0.2)', backdropFilter: 'blur(10px)' }}><GroupIcon sx={{ fontSize: 30, color: '#fff' }} /></Avatar>
                                <Box>
                                    <Typography variant="h5" sx={{ fontFamily: 'Cairo', fontWeight: 'bold', color: '#fff', textShadow: '0 4px 20px rgba(0,0,0,0.2)' }}>إدارة المستخدمين</Typography>
                                    <Typography variant="subtitle1" sx={{ fontFamily: 'Cairo', color: 'rgba(255,255,255,0.9)' }}>إدارة جميع حسابات المستخدمين في النظام</Typography>
                                </Box>
                            </Box>
                        </Box>
                    </Fade>
