...
const AssignDoctors = () => {
    ...
    return (
        <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f5f7fa 0%, #e4e8ec 100%)', pb: 6 }}>
            {/* Hero Header */}
            <Box sx={{ background: 'linear-gradient(135deg, #ed6c02 0%, #ff9800 100%)', pt: 3, pb: 4, mb: 3, position: 'relative', overflow: 'hidden' }}>
                ...
                <Container maxWidth="lg">
                    <Fade in={true} timeout={800}>
                        <Box>
                            <Button startIcon={<ArrowBackIcon />} onClick={() => navigate('/hod/dashboard')} sx={{ color: '#fff', mb: 2, fontFamily: 'Cairo', '&:hover': { bgcolor: 'rgba(255,255,255,0.1)' } }}>
                                العودة للوحة التحكم
                            </Button>
                                ...
                                <Box sx={{ mb: 4 }}>
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={12} sm={6} md={3}>
                                            ...
                                            <FormControl fullWidth disabled={!!user?.department}>
