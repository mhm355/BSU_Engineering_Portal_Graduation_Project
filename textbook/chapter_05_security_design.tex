...
The system implements a \textbf{seven-role authorization model} (Admin, Dean, HOD, Doctor, Student, Student Affairs, Staff Affairs). Authorization is enforced at the backend through ten custom Django REST Framework (DRF) [2] permission classes. 
...
\begin{sidewaystable}
    ...
    \begin{tabular}{|p{0.22\textwidth}|c|c|c|c|c|c|c|}
        \hline
        \textbf{Operation} & \textbf{Admin} & \textbf{Dean} & \textbf{HOD} & \textbf{Doctor} & \textbf{Student} & \textbf{Student Aff.} & \textbf{Staff Aff.} \\
        \hline
        User Management & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Academic Year CRUD & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Grading Template CRUD & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Department CRUD & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Upload Students & \cmark & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark \\ \hline
        Upload Doctors & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \cmark \\ \hline
        Assign Doctor & \cmark & \xmark & \cmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Record Attendance & \cmark & \xmark & \xmark & \cmark (Own) & \xmark & \xmark & \xmark \\ \hline
        Enter Grades & \cmark & \xmark & \xmark & \cmark (Own) & \xmark & \xmark & \xmark \\ \hline
        Upload Exam Grades & \cmark & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark \\ \hline
        Approve Exam Grades & \cmark & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Publish Results & \cmark & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Create Quizzes & \cmark & \xmark & \xmark & \cmark (Own) & \xmark & \xmark & \xmark \\ \hline
        Take Quizzes & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark & \xmark \\ \hline
        View Own Grades & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark & \xmark \\ \hline
        Upload Lectures & \cmark & \xmark & \xmark & \cmark (Own) & \xmark & \xmark & \xmark \\ \hline
        Manage News & \cmark & \xmark & \xmark & \xmark & \xmark & \cmark & \cmark \\ \hline
        Send Announcements & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        View Audit Logs & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Approve Deletions & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\ \hline
        Manage Certificates & \cmark & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark \\
        \hline
    \end{tabular}
\end{sidewaystable}
