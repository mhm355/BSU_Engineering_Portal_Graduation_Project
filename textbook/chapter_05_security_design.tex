...
Authorization operates at two distinct layers. The frontend utilizes a \texttt{<ProtectedRoute>} wrapper to route users away from unauthorized views and handle the mandatory password change redirect.
...
% The following table requires the longtable, pifont, and xcolor packages in your main .tex file.
\begin{longtable}{|p{0.28\textwidth}|c|p{0.12\textwidth}|c|p{0.12\textwidth}|p{0.12\textwidth}|}
    ...
    Record Attendance & \cmark & \cmark \newline (Own courses) & \xmark & \xmark & \xmark \\ \hline
    Enter Grades & \cmark & \cmark \newline (Own courses) & \xmark & \xmark & \xmark \\ \hline
    Upload Exam Grades & \cmark & \xmark & \xmark & \cmark & \xmark \\ \hline
    Approve Exam Grades & \cmark & \xmark & \xmark & \xmark & \xmark \\ \hline
    Create Quizzes & \cmark & \cmark \newline (Own courses) & \xmark & \xmark & \xmark \\ \hline
    ...
    Reset User Passwords & \cmark & \xmark & \xmark & \cmark \newline (Students only) & \xmark \\ \hline
