...
\begin{table}[htbp]
    ...
    \small
    \begin{tabular}{|c|p{3cm}|c|p{3cm}|p{4.5cm}|}
        \hline
...
\begin{table}[htbp]
    ...
    \renewcommand{\arraystretch}{1.4}
    \small
    \begin{tabular}{|c|p{3cm}|c|p{3.5cm}|p{4.5cm}|}
        \hline
        \textbf{ID} & \textbf{Limitation} & \textbf{Category} & \textbf{Impact} & \textbf{Proposed Mitigation} \\
        \hline
...
\begin{table}[htbp]
    ...
    \renewcommand{\arraystretch}{1.4}
    \small
    \begin{tabular}{|c|p{3cm}|c|p{3cm}|p{5cm}|}
        \hline
        \textbf{ID} & \textbf{Limitation} & \textbf{Category} & \textbf{Impact} & \textbf{Proposed Mitigation} \\
        \hline
        ...
        \hline
        L-18 & \textbf{Manual deployment step} & Operations & After CI/CD pushes new image, admin must manually run \texttt{docker-compose~\cite{docker-compose} pull \&\& up -d} on production server. & Implement webhook-triggered deployment: GitHub Actions calls deployment endpoint on production server to pull and restart automatically. \\
        \hline
    \end{tabular}
