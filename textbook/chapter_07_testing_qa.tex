...
\begin{lstlisting}[language=yaml, caption=Trivy Security Gate in CI/CD]
...
\begin{table}[H]
    ...
    \renewcommand{\arraystretch}{1.3}
    \small
    \begin{tabular}{|c|p{2.5cm}|p{3cm}|p{3cm}|c|}
        \hline
        \textbf{ID} & \textbf{Test Case} & \textbf{Input} & \textbf{Expected} & \textbf{Status} \\
        \hline
        TC-A01 & Valid login & admin / [valid] & Dashboard redirect & \textcolor{green!80!black}{\ding{51}} \\
        \hline
        TC-A02 & Invalid password & admin / wrong & Error message & \textcolor{green!80!black}{\ding{51}} \\
        \hline
        TC-A03 & First login & New student & Password change redirect & \textcolor{green!80!black}{\ding{51}} \\
        \hline
    \end{tabular}
    \caption{Authentication Test Cases}
\end{table}

\subsection{Student Affairs Test Cases}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{2.8cm}|p{3.5cm}|p{3cm}|c|}
        ...
        \textbf{ID} & \textbf{Test Case} & \textbf{Input} & \textbf{Expected} & \textbf{Status} \\
        \hline
        TC-SA01 & Upload Excel & 50 students & Created & \textcolor{green!80!black}{\ding{51}} \\
        \hline
        TC-SA02 & Duplicate & Existing student & Updated (upsert) & \textcolor{green!80!black}{\ding{51}} \\
        \hline
        TC-SA03 & Missing columns & No national\_id & Error message & \textcolor{green!80!black}{\ding{51}} \\
        \hline
    \end{tabular}
    \caption{Student Affairs Test Cases}
\end{table}
