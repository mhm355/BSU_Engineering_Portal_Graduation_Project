...
\usepackage{listings}
\usepackage{titlesec}
\usepackage[numbib]{tocbibind} % Automatically adds TOC, LOF, LOT to the Table of Contents, and numbers the bibliography
...
\include{chapter_06_devops_deployment}
\include{chapter_07_testing_qa}
\include{chapter_08_performance}
\include{chapter_09_results}
\include{chapter_10_limitations}
\include{chapter_11_conclusion}
\include{chapter_12_references}
