...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{4.5cm}|p{3.5cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Django~\cite{django} ORM Optimization Strategies}
...
\section{Pagination \& Lazy Loading}
...
\textbf{Impact:} A student user never downloads the Admin Dashboard code, reducing their initial bundle size.
