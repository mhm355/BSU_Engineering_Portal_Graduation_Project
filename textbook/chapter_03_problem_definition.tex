...
While the BSU Engineering Portal provides comprehensive Management Information System (MIS) capabilities for academic administration, traditional Learning Management System (LMS) features such as Discussion Forums and Live Virtual Classrooms are intentionally scoped for future phases. This distinguishes the current system from platforms like Moodle, focusing first on core administrative reliability before expanding into interactive pedagogical tools.
...
\begin{figure}[H]
    ...
    \caption{Stakeholder Interaction Diagram showing all seven roles (Admin, Dean, HOD, Doctor, Student, Student Affairs, Staff Affairs) and their primary data flows into the centralized system.}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.15\textwidth}|p{0.2\textwidth}|p{0.3\textwidth}|p{0.25\textwidth}|}
        ...
        \hline
        \textbf{Dean} & Executive Academic Head & Lack of visibility into grading pipelines and results. & Approve final grades, publish results, view analytics. \\
        \hline
...
\begin{itemize}
    ...
    \item \textbf{FR-05b [Must]}: The system shall require the Dean to explicitly approve exam grades before results can be published to students.
    \item \textbf{FR-05c [Must]}: The system shall restrict access to quizzes and attendance views for students who have not paid their tuition.
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{UML Use Case Diagram mapping the five primary system actors to their respective grouped use cases, illustrating the functional scope and permission boundaries of the portal.}
