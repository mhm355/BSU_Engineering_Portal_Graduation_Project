...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.15\textwidth}|p{0.3\textwidth}|p{0.45\textwidth}|}
        ...
        Sprint 2 & Student \& Staff Affairs & Batch Excel uploads (pandas [16]), student filtering. \\
...
\begin{figure}[H]
    ...
    \framebox[\textwidth]{\rule{0pt}{5cm} MISSING IMAGE: upload\_preview.png}
...
\begin{figure}[H]
    ...
    \framebox[0.8\textwidth]{\rule{0pt}{5cm} MISSING IMAGE: admin\_approval.png}
