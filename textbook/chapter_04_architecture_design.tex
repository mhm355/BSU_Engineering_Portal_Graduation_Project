...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{aws_architecture.png}
    \caption{Cloud Deployment Architecture on AWS, illustrating the use of a Virtual Private Cloud (VPC) with public and private subnets to isolate ECS Fargate compute tasks and the Amazon RDS database instance.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{backend_modules.png}
...
A custom \texttt{\textless ProtectedRoute\textgreater} wrapper component enforces client-side authorization barriers. It sequentially validates three conditions before rendering a protected page:
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{theme_comparison.png}
    \caption{Side-by-side comparison of the Student Dashboard illustrating the dynamic theme switching capability (Light Mode vs. Dark Mode), built with Material-UI and tailored for an Arabic RTL layout.}
