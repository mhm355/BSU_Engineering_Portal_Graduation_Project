...
The system was developed over \textbf{8 Agile sprints}, progressing from core authentication infrastructure to a fully containerized, CI/CD-deployed platform serving five distinct stakeholder roles across all five academic departments.
...
\begin{itemize}
    ...
    \item \textbf{Automated vulnerability scanning} via Trivy [14] in the GitHub Actions [15] CI/CD pipeline, blocking deployment of known-vulnerable images
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{GitOps CI/CD pipeline} with path-filtered triggers, Docker Hub publishing, Trivy scanning, and auto-updating compose files
...
\begin{itemize}
    ...
    \item \textbf{CI/CD engineering:} Implementing GitHub Actions pipelines with security scanning and automated infrastructure updates
...
GitHub, Inc., ``GitHub Actions: Automate Your Workflow from Idea to Production.'' [Online]. Available: \url{https://github.com/features/actions}. [Accessed: 2025].
...
\bibitem{github-docs}
GitHub, Inc., ``GitHub Actions Documentation.'' [Online]. Available: \url{https://docs.github.com/en/actions}. [Accessed: 2025].
