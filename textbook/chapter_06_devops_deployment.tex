...
This enables declarative deployment: operators run \texttt{docker compose -f docker-compose-im.yml pull andand docker compose up -d} to deploy the exact images validated by CI.
