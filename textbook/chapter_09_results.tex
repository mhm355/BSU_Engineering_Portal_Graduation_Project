...
\begin{figure}[htbp]
    ...
    \caption{User Management interface showing the list of system users with their assigned roles (Admin, Doctor, Student, Student Affairs, Staff Affairs), demonstrating the Role-Based Access Control (RBAC) implementation.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{student_aff_1.png}
        \caption*{\small (a) Department/level selection form}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{studen_aff_2.png}
        \caption*{\small (b) File upload area with drag-and-drop}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{student_aff_3.png}
        \caption*{\small (c) Preview table with validation status}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{quiz_1.png}
        \caption*{\small (a) Quiz Creation interface with question type selection}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{quiz_2.png}
        \caption*{\small (b) Student Quiz interface with timer and navigation}
    \end{minipage}
